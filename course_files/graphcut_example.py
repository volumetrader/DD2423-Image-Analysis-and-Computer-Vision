...
from Labb3.lab3 import kmeans_segm, mixture_prob
...
def graphcut_example():
    ...
    #area = [ 100, 100, 340, 240 ] # image region to train foreground with [ minx, miny, maxx, maxy ]
    K = 20#10                       # number of mixture components
    alpha = 17#5.0                  # maximum edge cost
    sigma = 10#15                # edge cost decay factor
